...
<body>
    <div id="app">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{route('updateprofile')}}">Update Profile</a>
                                <a class="dropdown-item" href="{{route('transaction')}}">Transaction</a>
                                <a class="dropdown-item" href="{{route('cart')}}">Cart</a>
                                
                                @else
                                     {{-- <a class="dropdown-item" href="#">Update Product</a> --}}
                                     <a class="dropdown-item" href="{{route('insertProduct')}}">Insert Product</a>
        ...
        <footer>
            <p><i> &copy;Copyright MbWekCenter 2021 </i></p>
        </footer>
    </div>
</body>
</html>
